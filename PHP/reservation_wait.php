...
mysql_query("set names UTF8");
	...
	$result=  mysql_result(mysql_query("update customer set RequestState=1 , DetailState=1 , Number='$seat',ClassNumber='$number',pc_last_num='$number' ,Time=now() where pw='$password' and birth='$birth';"),0);	 
...
$dir = "C:/APM_Setup/htdocs"; //insertresult.xml 占쎌쥙�ο옙節륁삕占쎈쪇�뺧옙醫롫짗占쎌눨�앾옙��텑占쎌쥙猷욑옙�낅눇�용뿫�ι쨹恝��$filename = $dir."/reservation_wait.xml";
