...
mysql_query("set names UTF8");
	...
	$result=  mysql_result(mysql_query("update customer set ClassNumber=1 , RequestState=1 , DetailState=2  where pw='$password' and birth='$birth';"),0);	 
...
$filename = $dir."/reservation_cancle.xml"; 
