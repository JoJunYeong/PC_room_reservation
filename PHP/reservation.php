...
$result=  mysql_result(mysql_query("update customer set no_ready=1 , no_status=1 , no_seat='$seat' where C_name='$name' and C_birth='$birth';"),0);
	
 
$xmlcode = "<?xml version = \"1.0\" encoding = \"UTF-8\" ?>\n"; //xml占쎈슣�わ옙占썹빊�뺤젾占쏙옙�꾨뗀諭�
$xmlcode .= "<result>$result</result>\n"; //DB inse1rt揶쏉옙占쎄퉫�э옙怨몄몵嚥∽옙占쎈Ŧ�쀯쭪占쏙옙�占썹몴占쏙옙類ㅼ뵥占쎌꼵由�占쎄쑵鍮�result揶쏅���xml嚥∽옙�곗뮆�곤옙�쀪땀
 
$dir = "C:/APM_Setup/htdocs"; //insertresult.xml 占쎈슣�わ옙占쏙옙占쎌삢占쏙옙野껋럥以�
$filename = $dir."/reservation.xml";
